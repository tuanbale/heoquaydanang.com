		...
		public function free_pro() {
		    ...
		    if ( ! empty( $free_pro ) ) {
		        ...
		        if ( ! empty( $free_pro ) && is_array( $free_pro ) ) {
		            ...
		            echo '<td></td>';
		            echo '<td colspan="2"><a href="https://www.prodesigns.com/wordpress-themes/downloads/super-construction-plus/" target="_blank" class="button button-primary button-hero">Super Construction Plus</a></td>';
		            echo '</tr>';
