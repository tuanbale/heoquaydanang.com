...
if ( ! class_exists( 'Super_Construction_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Super_Construction_Demo {

		/**
		 * Singleton instance of Super_Construction_Demo.
		 *
		 * @var Super_Construction_Demo $instance Super_Construction_Demo instance.
		 */
		...
		/**
		 * Main Super_Construction_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Super_Construction_Demo ) ) {
				self::$instance = new Super_Construction_Demo();
