	...
	class WPSEO_Local_Admin_General_Settings {
		...
		public function advanced() {
			...
			if ( true == is_ssl() ) {
				...
				echo '<p class="desc label" style="border:none; margin-bottom: 0;"><em>' . sprintf( __( 'This option only works on HTTPS websites. Using HTTPS is important, read more about it in the %1$sYoast KB%2$s', 'yoast-local-seo' ), '<a href="https://yoa.st/local-seo-https">', '</a>' ) . '</em></p>';
			}
